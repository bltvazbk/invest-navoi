...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    contact: {
      ...
      address: '77A, Amir Temur Street, Navoi city, Navoi Region',
  ...
  ru: {
    ...
    contact: {
      ...
      address: 'ул. Амира Темура, 77А, г. Навои, Навоийская область',
  ...
  uz: {
    ...
    contact: {
      ...
      address: 'Amir Temur ko‘chasi, 77A, Navoiy shahri, Navoiy viloyati',
